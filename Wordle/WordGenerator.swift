...
class WordGenerator {
  ...
  static let possibleWords = ["ABCDE", "APPLE", "BACON", "CARAT", "DINGO", "EAGLE", "FAIRY", "GIANT", "HAZEL", "IVORY", "JELLY", "KIOSK", "LEMON", "MAGIC", "NOBLE", "OASIS", "PIANO", "QUEEN", "RADAR", "SOLAR", "TULIP", "UNITY", "VALVE", "WALTZ", "XENON", "YACHT", "ZEBRA", "ALLOY", "BLITZ", "CANDY"]
  static func generateRandomWord() -> String? {
    // START YOUR CODE HERE
      let rand = possibleWords.randomElement()
